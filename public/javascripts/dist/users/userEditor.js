...
var UserEditorComponent = (function () {
    function UserEditorComponent(formBuilder, usersService) {
        ...
        this.login = new forms_1.FormControl("", forms_1.Validators.compose([
            forms_1.Validators.required, validation_service_1.CustomValidationService.CheckLogin
        ]));
        this.password = new forms_1.FormControl("", forms_1.Validators.compose([
            forms_1.Validators.required, validation_service_1.CustomValidationService.CheckPassword
        ]));
        this.firstName = new forms_1.FormControl("", forms_1.Validators.compose([
            forms_1.Validators.required, validation_service_1.CustomValidationService.CheckName
        ]));
        this.lastName = new forms_1.FormControl("", forms_1.Validators.compose([
            forms_1.Validators.required, validation_service_1.CustomValidationService.CheckName
        ]));
